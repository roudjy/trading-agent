# INSTALLATIEGIDS â€” JvR Trading Agent
## Van nul naar live in Ã©Ã©n avond

---

## STAP 1 â€” Accounts aanmaken (jij doet dit)
...
5. â³ Wacht 2-5 werkdagen op goedkeuring
...
4. Ga naar Instellingen â†’ API â†’ Maak nieuwe API sleutel aan
...
4. Ga naar Security â†’ API â†’ Create API Key
5. Rechten: **Query** + **Trade** (NIET withdraw)
6. Noteer: **API Key** en **Private Key**

### 1d. MetaMask (voor Polymarket)
1. Ga naar **metamask.io** â†’ Download browser extensie
2. Maak nieuwe wallet aan
3. Schrijf je **12 woorden seed phrase OP PAPIER** â†’ bewaar veilig
...
3. Create App â†’ Netwerk: **Polygon Mainnet**
...
3. Billing â†’ Add $10 credit (genoeg voor maanden)
4. API Keys â†’ Create Key
5. Noteer je **API Key** (begint met sk-ant-...)

---

## STAP 2 â€” VPS instellen (via Terminal op je Mac)

Open Terminal op je Mac (Spotlight â†’ "Terminal")
...
## STAP 3 â€” Project uploaden naar VPS
...
echo "Project geÃ¼pload!"
```

---

## STAP 4 â€” API Keys invullen
...
exchanges:
  bitvavo:
    actief: true              # â† Verander naar true
    api_key: "jouw-key-hier"  # â† Invullen
    api_secret: "jouw-secret" # â† Invullen
    paper_trading: true       # â† Laat op true! (papier trading eerst)
...
agent  | 2026-04-01 07:00:01 | INFO | Startkapitaal: â‚¬1000
...
## STAP 7 â€” Paper trading fase (VERPLICHT, minimaal 4 weken)
...
2. Controleren of de strategieÃ«n logisch handelen
...
>
> - `research/paper_readiness.py` â€” closed blocking-reason taxonomy.
> - `docs/handoffs/v3.15-to-v3.16.md` Â§2 â€” narrative summary.
>
...
```yaml
paper_trading: false    # â† Verander naar false
```
...
âš ï¸ Zorg dat je daadwerkelijk geld op de exchanges hebt gestort.
