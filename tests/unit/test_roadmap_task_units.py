...
def test_ade_qre_018a_to_018k_each_have_one_seed_unit(snap: dict) -> None:
    by_phase = _units_by_phase(snap)
    for phase in (
        "ade_qre_018a",
        "ade_qre_018b",
...
def test_ade_qre_019a_to_019m_each_have_one_seed_unit(snap: dict) -> None:
    by_phase = _units_by_phase(snap)
    for phase in (
        "ade_qre_019a",
        "ade_qre_019b",
...
def test_ade_qre_020a_to_020q_each_have_one_seed_unit(snap: dict) -> None:
    by_phase = _units_by_phase(snap)
    for phase in (
        "ade_qre_020a",
        "ade_qre_020b",
...
def test_ade_qre_022a_to_022o_each_have_one_seed_unit(snap: dict) -> None:
    by_phase = _units_by_phase(snap)
    for phase in (
        "ade_qre_022a",
        "ade_qre_022b",
...
def test_ade_qre_023a_to_023p_each_have_one_seed_unit(snap: dict) -> None:
    by_phase = _units_by_phase(snap)
    for phase in (
        "ade_qre_023a",
        "ade_qre_023b",
...
def test_ade_qre_024a_to_024p_each_have_one_seed_unit(snap: dict) -> None:
    by_phase = _units_by_phase(snap)
    for phase in (
        "ade_qre_024a",
        "ade_qre_024b",
...
def test_ade_qre_025a_to_025o_each_have_one_seed_unit(snap: dict) -> None:
    by_phase = _units_by_phase(snap)
    for phase in (
        "ade_qre_025a",
        "ade_qre_025b",
...
def test_ade_qre_026a_to_026r_each_have_one_seed_unit(snap: dict) -> None:
    by_phase = _units_by_phase(snap)
    for phase in (
        "ade_qre_026a",
        "ade_qre_026b",
