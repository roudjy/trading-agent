    ...
    _write_json(
        ...
        "logs/qre_identity_ambiguity_resolution/latest.json",
        {
            ...
            "rows": [
                ...
                {
                    "dataset_identity": "crypto-ohlcv-yfinance-v1",
    ...
    _write_json(
        ...
        "logs/qre_data_cache_manifest/latest.json",
        {
            ...
            "coverage": [
                ...
                {
                    "content_hash": "sha256:btc-eur-1h-fresh",
                    "instrument": "BTC-EUR",
                    "max_timestamp_utc": "2026-06-30T00:00:00Z",
                    "min_timestamp_utc": "2025-10-01T00:00:00Z",
                    "ready": True,
                ...
                {
                    "content_hash": "sha256:eth-eur-1h-fresh",
                    "instrument": "ETH-EUR",
                    "max_timestamp_utc": "2026-06-30T00:00:00Z",
                    "min_timestamp_utc": "2025-10-01T00:00:00Z",
                    "ready": True,
                ...
                {
                    "content_hash": "sha256:sol-eur-1h-fresh",
                    "instrument": "SOL-EUR",
                    "max_timestamp_utc": "2026-06-30T00:00:00Z",
                    "min_timestamp_utc": "2025-10-01T00:00:00Z",
                    "ready": True,
                ...
                {
                    "content_hash": "sha256:btc-usd-4h-fresh",
                    "instrument": "BTC-USD",
                    "max_timestamp_utc": "2026-06-30T00:00:00Z",
                    "min_timestamp_utc": "2025-10-01T00:00:00Z",
                    "ready": True,
                ...
                {
                    "content_hash": "sha256:eth-usd-4h-fresh",
                    "instrument": "ETH-USD",
                    "max_timestamp_utc": "2026-06-30T00:00:00Z",
                    "min_timestamp_utc": "2025-10-01T00:00:00Z",
                    "ready": True,
                ...
                {
                    "content_hash": "sha256:sol-usd-4h-fresh",
                    "instrument": "SOL-USD",
                    "max_timestamp_utc": "2026-06-30T00:00:00Z",
                    "min_timestamp_utc": "2025-10-01T00:00:00Z",
                    "ready": True,
