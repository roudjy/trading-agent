...
def test_current_queue_selects_017a_after_016h_done() -> None:
    ...
    assert rows["ADE-QRE-017A"]["auto_selectable"] is True
    assert rows["ADE-QRE-017B"]["status"] == "blocked until ADE-QRE-017A done"
