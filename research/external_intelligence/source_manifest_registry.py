...
SOURCE_MANIFEST_ROWS: Final[tuple[dict[str, object], ...]] = (
    ...
    },
    {
        ...
        "expected_latency": "symbology_api_latency_unknown",
        "expected_freshness": "reference_master_update_schedule_unknown",
        ...
        "known_limitations": [
            "api_key_may_be_required_for_scaled_use",
            "fundamental_fields_unsupported",
            "not_fundamental_source",
            "symbology_only",
        ],
        ...
        "manifest_block_reasons": ["LICENSE_REVIEW_REQUIRED"],
        "operator_notes": (
            "Identity context only. Alias-resolution review and license review are required before any read-only "
            "identity usage, and this manifest must never unlock fundamental field readiness."
        ),
    },
    {
