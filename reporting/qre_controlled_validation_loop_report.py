...
def collect_snapshot(
    *,
    ...
    return {
        ...
        "read_only": execution_snapshot.get("read_only") is not False,
        "eligible_for_direct_execution": False,
        "launches_subprocess": execution_snapshot.get("launches_subprocess") is True,
        "launches_codex": False,
        "executed_anything": execution_snapshot.get("executed_anything") is True,
